...
void Bloom::install()
{
	...
	ms_weightMultiplier = std::max(0.0f, ConfigFile::getKeyFloat ("ClientGame/Bloom",  "weightMultiplier", 1.5f));
	ms_softPower = std::max(0.1f, ConfigFile::getKeyFloat ("ClientGame/Bloom", "softPower", 0.85f));
	ms_glowScale = std::max(0.0f, ConfigFile::getKeyFloat ("ClientGame/Bloom", "glowScale", 0.9f));
