...
CString CMainFrame::_getThemeDisplayName() const
{
        ...
        case ThemeStyleLuminousLight:
                return _T("Luminous Light");
        case ThemeStyleBlueprint:
                return _T("Blueprint Grid");
        case ThemeStyleAurora:
                return _T("Aurora Glow");
        case ThemeStyleSolar:
                return _T("Solar Noir");
        case ThemeStyleCarbon:
                return _T("Carbon Fiber");
        case ThemeStyleNordic:
                return _T("Nordic Frost");
        default:
                break;
        }
...
void CMainFrame::_applyTheme(ThemeStyle style, bool persist)
{
        ...
        {
        case ThemeStyleNeoDark:
                m_canvasBackgroundColor.Set(12, 16, 24, 255);
                gGridColor.Set(72, 112, 160, 56);
                m_layoutGuideColor.Set(64, 196, 255, 200);
                m_safeZoneColor.Set(255, 196, 0, 40);
                m_focusOverlayColor.Set(0, 0, 0, 160);
                m_highlightOutlineColor.Set(0, 220, 180, 255);
                m_selectionOutlineColor.Set(72, 163, 255, 255);
                m_highlightSelectionOutlineColor.Set(255, 214, 10, 255);
                m_selectionFillColor.Set(72, 163, 255, 32);
                m_selectionBoxOutlineColor.Set(96, 164, 255, 192);
                m_selectionDragBoxOutlineColor.Set(0, 196, 255, 255);
                break;
        case ThemeStyleLuminousLight:
                m_canvasBackgroundColor.Set(246, 246, 250, 255);
                gGridColor.Set(140, 148, 160, 64);
                m_layoutGuideColor.Set(0, 120, 212, 180);
                m_safeZoneColor.Set(0, 120, 212, 32);
                m_focusOverlayColor.Set(255, 255, 255, 130);
                m_highlightOutlineColor.Set(40, 145, 255, 255);
                m_selectionOutlineColor.Set(30, 30, 30, 255);
                m_highlightSelectionOutlineColor.Set(220, 130, 0, 255);
                m_selectionFillColor.Set(30, 30, 30, 32);
                m_selectionBoxOutlineColor.Set(60, 120, 200, 200);
                m_selectionDragBoxOutlineColor.Set(30, 145, 255, 255);
                break;
        case ThemeStyleBlueprint:
                m_canvasBackgroundColor.Set(8, 26, 54, 255);
                gGridColor.Set(0, 140, 255, 72);
                m_layoutGuideColor.Set(255, 255, 255, 180);
                m_safeZoneColor.Set(0, 90, 190, 48);
                m_focusOverlayColor.Set(4, 20, 40, 150);
                m_highlightOutlineColor.Set(255, 255, 255, 255);
                m_selectionOutlineColor.Set(0, 180, 255, 255);
                m_highlightSelectionOutlineColor.Set(255, 255, 255, 255);
                m_selectionFillColor.Set(0, 180, 255, 32);
                m_selectionBoxOutlineColor.Set(0, 200, 255, 200);
                m_selectionDragBoxOutlineColor.Set(255, 255, 255, 255);
                break;
        case ThemeStyleAurora:
                m_canvasBackgroundColor.Set(10, 18, 40, 255);
                gGridColor.Set(120, 90, 255, 70);
                m_layoutGuideColor.Set(0, 255, 190, 220);
                m_safeZoneColor.Set(255, 64, 160, 48);
                m_focusOverlayColor.Set(20, 0, 48, 170);
                m_highlightOutlineColor.Set(0, 255, 210, 255);
                m_selectionOutlineColor.Set(90, 200, 255, 255);
                m_highlightSelectionOutlineColor.Set(255, 144, 234, 255);
                m_selectionFillColor.Set(90, 200, 255, 32);
                m_selectionBoxOutlineColor.Set(110, 210, 255, 200);
                m_selectionDragBoxOutlineColor.Set(255, 96, 196, 255);
                break;
        case ThemeStyleSolar:
                m_canvasBackgroundColor.Set(28, 24, 18, 255);
                gGridColor.Set(255, 140, 0, 70);
                m_layoutGuideColor.Set(255, 210, 64, 210);
                m_safeZoneColor.Set(255, 90, 0, 52);
                m_focusOverlayColor.Set(0, 0, 0, 170);
                m_highlightOutlineColor.Set(255, 200, 64, 255);
                m_selectionOutlineColor.Set(255, 176, 0, 255);
                m_highlightSelectionOutlineColor.Set(255, 236, 150, 255);
                m_selectionFillColor.Set(255, 176, 0, 40);
                m_selectionBoxOutlineColor.Set(255, 200, 80, 200);
                m_selectionDragBoxOutlineColor.Set(255, 120, 0, 255);
                break;
        case ThemeStyleCarbon:
                m_canvasBackgroundColor.Set(18, 22, 28, 255);
                gGridColor.Set(90, 110, 130, 72);
                m_layoutGuideColor.Set(0, 220, 255, 220);
                m_safeZoneColor.Set(255, 80, 60, 52);
                m_focusOverlayColor.Set(0, 0, 0, 190);
                m_highlightOutlineColor.Set(255, 255, 255, 255);
                m_selectionOutlineColor.Set(0, 200, 210, 255);
                m_highlightSelectionOutlineColor.Set(255, 255, 255, 255);
                m_selectionFillColor.Set(0, 200, 210, 36);
                m_selectionBoxOutlineColor.Set(0, 190, 230, 210);
                m_selectionDragBoxOutlineColor.Set(255, 110, 70, 255);
                break;
        case ThemeStyleNordic:
                m_canvasBackgroundColor.Set(224, 236, 240, 255);
                gGridColor.Set(140, 180, 200, 68);
                m_layoutGuideColor.Set(36, 140, 170, 220);
                m_safeZoneColor.Set(120, 200, 255, 44);
                m_focusOverlayColor.Set(255, 255, 255, 150);
                m_highlightOutlineColor.Set(0, 120, 160, 255);
                m_selectionOutlineColor.Set(30, 70, 110, 255);
                m_highlightSelectionOutlineColor.Set(60, 170, 200, 255);
                m_selectionFillColor.Set(30, 70, 110, 32);
                m_selectionBoxOutlineColor.Set(60, 140, 190, 210);
                m_selectionDragBoxOutlineColor.Set(0, 160, 200, 255);
                break;
        default:
                break;
        }
